...
public class Contributors {
  public static void main(String[] args) throws IOException {
    ...
    int m = 2;
    String s = "https://api.github.com/repos/alibaba/fastjson/contributors?per_page=100&anon=1";
    URL url = new URL(s);
    ...
    while (in.hasNext()) {
      ...
      s = "https://api.github.com/repos/alibaba/fastjson/contributors?per_page=100&page="+m+"&anon=1";
      url = new URL(s);
