...
public class commits {
  public static void main(String[] args) throws IOException, ParseException {
    ...
    String s = "https://api.github.com/repos/alibaba/fastjson/commits?per_page=100";
    URL url = new URL(s);
    PrintWriter out = new PrintWriter("commits.txt");
    PrintWriter out2 = new PrintWriter("Time.txt");
    ...
    while (m != 45) {
      ...
      s = "https://api.github.com/repos/alibaba/fastjson/commits?per_page=100&page="+m;
      url = new URL(s);
